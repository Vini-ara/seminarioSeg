...
CREATE TABLE "_CargoToUser" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_CargoToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "Cargo" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_CargoToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
